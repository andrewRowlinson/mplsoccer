...
from ._pitch_base import BasePitchAmericanFootball

__all__ = ['AmericanFootball', 'VerticalAmericanFootball']


class AmericanFootball(BasePitchAmericanFootball):
...
class VerticalAmericanFootball(BasePitchAmericanFootball):
