...
def read_event(path_or_buf):
    ...
    Parameters
        ...
        Examples
        --------
        # read from path - note change path to naviage to open-data folder 
    ...
    # because some columns were contained in dictionaries they have been split into seperate columns
