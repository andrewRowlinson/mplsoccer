        ...
        if self.orientation == 'horizontal':
            if plot_football:
                ...
                if 'label' in kwargs.keys():
                    Legend.update_default_handler_map({sc_hex: HandlerFootball(edgecolors=[pentcolor,pentcolor],
...
class HandlerFootball(HandlerPathCollection):
    """Automatically generated by Pitch.scatter() to allow use of football in legend."""
    
    def __init__(self, edgecolors=None, facecolors=None, sizes=None, linewidths=None,
                 marker_pad=0.3, numpoints=None, yoffsets=None, xpad=0., ypad=0., **kw):
