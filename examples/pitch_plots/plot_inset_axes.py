...
The Pitch classes have two functions which allow you to inset embedded axes,
with their own coordinate system, into the pitch.
...
position_axes = pitch.inset_formation_axes('433', length=12, width=12 / pitch.ax_aspect,
                                           ax=axes['pitch'])
